...
class OpenArms(Command):
    ...
    def isFinished(self):
        return self._robot.arm.get_open_count() >= 28 or self._robot.arm.is_open()
...
class CloseArms(Command):
    ...
    def isFinished(self):
        return self._robot.arm.get_open_count() >= 25 or not self._robot.arm.is_open()
...
class RaiseArms(Command):
    ...
    def isFinished(self):
        is_finished = self._robot.arm.get_vertical_count() >= 130 or not self._robot.arm.is_lowered()
        return is_finished
...
class LowerArms(Command):
    ...
    def isFinished(self):
        is_finished = self._robot.arm.get_vertical_count() >= 90 or self._robot.arm.is_lowered()
        return is_finished
